...
namespace VisionUnion
{
    ...
    {
        public static void Average(NativeArray<float3> pixelBuffer, NativeArray<float3> pixelOut, 
        ...
        public static void Average(ImageData<float3> input, ImageData<float3> output, 
